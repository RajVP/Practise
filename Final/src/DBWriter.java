           ...
           while (retry) {
                ...
                try {
                    ...
                    for (int j = 0; j < 10; j++) {
                        ...
                        // Get the data
                        PayloadData pd = new PayloadData(i+j, getName(), generator.nextDouble());
                    ...
                    // commit
                    //System.out.println(getName() + " : committing action : " + (i+1));
                   // System.out.println("Committing all actions : True");
                  //		 System.out.println(getName() + " : Found " + countRecords(null) + " entries in the database.");
                    try {
                        txn.commit();
                        txn = null;
